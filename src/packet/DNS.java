...
public class DNS {
	...
	String result = String.format("ID: 0x%04x, %s, Opcode: %s, Return Code: %s, Authoritative: %s, Truncated: %s, Recursion desired: %s, Recursion avail: %s\n", this.id, (this.query ? "Query" : "Response"), strOpcode, strRcode, this.authoritative, this.truncated, this.recursionDesired, this.recursionAvailable);
